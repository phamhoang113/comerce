		...
		<div class="container-login100" style="background-image: url('../css/tai-khoan/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<a href="../../Comerce/trang-chinh/index.php"><img src="../css/trang-chu/img/logo.png" width = "80px" alt=""></a>
					</span>
					...
					<div class="text-center p-t-90">
						...
						<a class="txt1" href="../../Comerce/tai-khoan/cap-nhat-tk.php">
							Cập nhật tài khoản ?
						</a> or
						<a class="txt1" href="../../Comerce/tai-khoan/doi-mk.php.php">
							Đổi mật khẩu ?
						</a>
					</div>
				</form>
