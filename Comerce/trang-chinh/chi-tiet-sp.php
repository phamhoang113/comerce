...
<head>
    ...
    <link rel="stylesheet" href="../../Comerce/css/chi-tiet-sp/products.css">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../../Comerce/css/chi-tiet-sp/plugin/css/owl.carousel.min.css">
    <link rel="stylesheet" href="../../Comerce/css/chi-tiet-sp/plugin/css/owl.theme.default.min.css">
...
<body>
    ...
    <script type="text/javascript" src="../../Comerce/css/chi-tiet-sp/plugin/js/owl.carousel.min.js"></script>
        ...
        <div class="row">
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
                <div class="login">
                  ...
                  ?>
                  <a href="../../Comerce/tai-khoan/dang-nhap.php"><p><strong>ĐĂNG NHẬP / ĐĂNG KÍ</strong></p></a> 
                    <?php }else{ ?>
                        <a href="../../Comerce/tai-khoan/thong-tin-tk.php"><p><strong>XIN CHÀO <?=$_SESSION['user']['ho_ten']?></strong></p></a>
                  <?php } ?>
                </div>
            ...
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
                <div class="logo">
                <a href="index.php"><img src="../css/trang-chu/img/logo.png" alt="anh"></a>
                </div>
            </div>
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
...
">
 ...
 ============================================ -->
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <?php
                    require_once ('../../Comerce/admin/dao/hang-hoa.php');
                        extract($_REQUEST);
            ...
            <div class="col-md-4" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt="" style="width:100%;">
                </div>
            </div>
            <div class="col-md-5">
                <div class="thongtinsp">
                    <ul>
                        ...
                        <li class="gu" style="margin-top: 20px;"> <img src="../../Comerce/css/chi-tiet-sp/img/ttt.png" alt=""> </li>
                        ...
                        <!-- MÃ CODE PHP CHECK ĐĂNG NHẬP ĐỂ MUA HÀNG -->
                            ...
                            <?php
                                if(!isset($_SESSION['user'])){
                            ?>
                            <a href="../../Comerce/tai-khoan/dang-nhap.php"><button style="margin-top:-5px;" class="btn btn-dark">ĐĂNG NHẬP ĐỂ MUA HÀNG</button></a>
                                <?php }else{ ?>
            ...
            <div class="col-md-3">
                <div class="thanhtoan">
                   ...
                   <h5>PHƯƠNG THỨC THANH TOÁN</h5>
                    <ul>
                        <li> <img src="../../Comerce/css/chi-tiet-sp/img/l2.png" alt=""> </li>
                        <li> <img src="../../Comerce/css/chi-tiet-sp/img/l1.png" alt=""> </li><br>
                        <li> <img src="../../Comerce/css/chi-tiet-sp/img/l4.png" alt=""> </li>

                        <li> <img src="../../Comerce/css/chi-tiet-sp/img/l3.png" alt=""> </li>
                    </ul>
                   </div>
                   <div class="row">
                     <a href="danh-sach-sp.php"><img src="../../Comerce/css/chi-tiet-sp/img/SALE.png" alt="" style="width:100%"></a>  
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                       <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img style="width: 200px" src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='cung-loai'><?=$ten_loai?></span></a>
                    </div>
                        <?php } ?>
                </div>
            </div>
        ...
        <div class="row">
            <div class="container" style="margin-top: 50px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="fo">
                        <img src="../css/trang-chu/img/logo.png" alt="" style ="width:60px;">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="fo">
