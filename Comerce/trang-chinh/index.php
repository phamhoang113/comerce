...
<body>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="sign">
                        ...
                        ?>
                        <a class="signup-btn" href="../../Comerce/tai-khoan/dang-nhap.php"><span>Đăng nhập</span> </a>
                        <?php }else{ ?>
                        <a  class="signup-btn" href="../../Comerce/tai-khoan/thong-tin-tk.php"><span><?=$_SESSION['user']['ho_ten'] ?> </span></a>
                        <?php } ?>
                    </div>
                </div>
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img class="card-img-top" src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt="Card image top"></a>
                    <div class="card-body">
