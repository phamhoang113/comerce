...
<head>
    ...
    <link rel="stylesheet" href="../../Comerce/css/tin-tuc/tintuc.css">
                ...
                <div class="row">
                    <div class="out">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <img src="../../Comerce/css/tin-tuc/img/1.jpg" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../../Comerce/css/tin-tuc/img/2.jpg" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../../Comerce/css/tin-tuc/img/3.jpg" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../../Comerce/css/tin-tuc/img/5.jpg" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../../Comerce/css/tin-tuc/img/7.jpg" alt="">
                                </td>
                                <td>
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/6.jpg" class="card-img-top" alt="...">
                    ...
                    ">
                            ...
                            <p class="ngay"> <img src="../../Comerce/css/tin-tuc/img/h.png" alt=""> </p>

                        </div>
                    </div>

                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/5.jpg" class="card-img-top" alt="...">
                        <div class="card-body" style="
                        padding-top: 0px;
                        padding-right: 0px;
                        padding-bottom: 0px;
                    ...
                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/7.jpg" class="card-img-top" alt="...">
                        <div class="card-body" style="
                        padding-top: 0px;
                        padding-right: 0px;
                        padding-bottom: 0px;
                    ...
                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/8.jpg" class="card-img-top" alt="...">
                        <div class="card-body" style="
                        padding-top: 0px;
                        padding-right: 0px;
                        padding-bottom: 0px;
                    ...
                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/2.jpg" class="card-img-top" alt="...">
                        <div class="card-body" style="
                        padding-top: 0px;
                        padding-right: 0px;
                        padding-bottom: 0px;
                    ...
                    <div class="card" style="width: 14rem;">
                        <img src="../../Comerce/css/tin-tuc/img/1.jpg" class="card-img-top" alt="...">
                        <div class="card-body" style="
                        padding-top: 0px;
                        padding-right: 0px;
                        padding-bottom: 0px;
