...
<head>
    ...
    <link rel="stylesheet" href="../../Comerce/css/danh-sach-sp/products.css">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../../Comerce/css/danh-sach-sp/plugin/css/owl.carousel.min.css">
    <link rel="stylesheet" href="../../Comerce/css/danh-sach-sp/plugin/css/owl.theme.default.min.css">
...
<body>
    ...
    <script type="text/javascript" src="../../Comerce/css/danh-sach-sp/plugin/js/owl.carousel.min.js"></script>
...
">
                    ...
                    <!-- CODE PHP DANH MỤC -->
                    <?php
                        require_once ('../../Comerce/admin/dao/loai-hang.php');
                        extract($_REQUEST);
                    ...
                    <div class="row" style="margin-top: 35px;margin-left: 0px;">
                        ...
                        ?>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-4"><a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>&ma_loai=<?=$ma_loai?>"><img style="width:80px;" src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt=""></a></div>
            ...
            ?>
                ...
                <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><span class="chi-tiet">CHI TIẾT</span></a>
                    ...
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img  src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt=""><span class='hang-moi'>Hàng mới</span></a>
                    <div class="glow-wrap">
    <i class="glow"></i>
  </div>
                    <div class="text">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                        <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img style="width: 200px" src="../../Comerce/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='noi-bat'>HOT</span></a>
                    </div>
                        <?php } ?>
