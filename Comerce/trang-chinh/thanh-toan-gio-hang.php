...
">
    ...
    <?php
        require_once ('../../Comerce/admin/dao/khach-hang.php');
        ...
        <input type="text" class="form-control" id="" name="ma_kh" value="<?=$ma_kh?>" hidden>
            ...
            <thead>
                ...
                <tr>
                        ...
                        <td><button type="submit" name="dathangonline" class="btn btn-danger"><a href="../../Comerce/vnpay_php/index.php">ĐẶT HÀNG VÀ THANH TOÁN ONLINE</a></button></td>
                </tr>
                </tbody>
            </table>        
            <li><a href="danh-sach-sp.php">TRANG CHỦ</a></li>
            ...
            <?php
                require_once ('../../Comerce/admin/dao/hoa-don.php');
